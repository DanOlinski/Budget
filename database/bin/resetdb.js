...
//This function runs both functions from above. When running npm db:reset from the terminal this is the function that is triggered since it's the only function being called bellow
